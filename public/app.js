...
function createPrintableHTML(resultsContent, toolName, timestamp) {
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <title>EduBlink - ${toolName} Results</title>
      <style>
        * {
          margin: 0;
          padding: 0;
    ...
    <body>
      <div class="header">
        <h1>🎓 EduBlink - ${toolName} Results</h1>
        <div class="subtitle">AI-Powered Educational Content Generator</div>
      ...
      <div class="footer">
        <p>Generated by EduBlink | Your AI Teaching Superpower</p>
        <p>edublink.onrender.com</p>
      </div>
    </body>
    </html>
  `;
